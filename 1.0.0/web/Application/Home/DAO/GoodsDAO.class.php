...
class GoodsDAO extends PSIBaseExDAO
{
  ...
  {
    return $code == 1000 || $code == 2000 || $code == 3000 || $code == 4000 || $code == 5000;
  }
  ...
  public function getGoodsById($id)
  {
    ...
    $sql = "select code, name, spec, m_type from t_goods where id = '%s' ";
  ...
  public function queryData($params)
  {
    ...
    foreach ($data as $v) {
      ...
      if ($warehouseId) {
        ...
        $sql = "select convert(balance_count, $fmt) as inv_cnt from t_inventory
