...
class FIdConst
{
  ...
  /**
   * 用户管理 - 组织机构在业务单据中的使用权限，数据权限
   */
  const USER_MANAGEMENT_ORGS = "-8999-01";

  /**
   * 用户管理 - 业务员在业务单据中的使用权限，数据权限
   */
  const USER_MANAGEMENT_USERS = "-8999-02";
