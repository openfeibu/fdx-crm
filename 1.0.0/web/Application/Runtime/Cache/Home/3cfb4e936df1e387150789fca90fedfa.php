...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/InvCheck/InvCheckMainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/InvCheck/ICEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
  PCL.onReady(() => {
    ...
    app.add(PCL.create("PSI.InvCheck.InvCheckMainForm", {
      permission
    }));
  });
</script>
