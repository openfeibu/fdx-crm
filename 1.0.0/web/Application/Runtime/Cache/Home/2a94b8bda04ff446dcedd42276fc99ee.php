...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Home/MainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script>
  PCL.onReady(() => {
    ...
    app.add(PCL.create("PSI.Home.MainForm", {
      pSale: "<?php echo ($pSale); ?>",
      pInventory: "<?php echo ($pInventory); ?>",
      pPurchase: "<?php echo ($pPurchase); ?>",
      pMoney: "<?php echo ($pMoney); ?>",
      productionName: "<?php echo ($productionName); ?>"
    }));
  });
</script>
