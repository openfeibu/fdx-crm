...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Factory/MainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Factory/CategoryEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Factory/FactoryEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
  PCL.onReady(() => {
    ...
    const permission = {
      addCategory: "<?php echo ($pAddCategory); ?>",
      editCategory: "<?php echo ($pEditCategory); ?>",
      deleteCategory: "<?php echo ($pDeleteCategory); ?>",
      add: "<?php echo ($pAdd); ?>",
      edit: "<?php echo ($pEdit); ?>",
      del: "<?php echo ($pDelete); ?>"
    };

    app.add(PCL.create("PSI.Factory.MainForm", {
      permission
    }));
  });
</script>
