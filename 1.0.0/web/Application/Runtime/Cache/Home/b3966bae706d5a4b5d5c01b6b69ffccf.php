...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/InvTransfer/InvTransferMainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/InvTransfer/ITEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
  PCL.onReady(() => {
    ...
    app.add(PCL.create("PSI.InvTransfer.InvTransferMainForm", {
      permission
    }));
  });
</script>
