...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Inventory/InitInventoryMainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Inventory/InitInventoryEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
  PCL.onReady(() => {
    ...
    app.add(PCL.create("PSI.Inventory.InitInventoryMainForm"));
  });
</script>
