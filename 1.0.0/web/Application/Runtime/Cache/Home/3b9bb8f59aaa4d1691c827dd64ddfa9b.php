...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/About/MainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script>
  PCL.onReady(() => {
    const form = PCL.create("PSI.About.MainForm", {
      productionName: "<?php echo ($productionName); ?>",
      phpVersion: "<?php echo ($phpVersion); ?>",
      mySQLVersion: "<?php echo ($mySQLVersion); ?>",
      PSIDBVersion: "<?php echo ($PSIDBVersion); ?>",
      PSIDBUpdateDT: "<?php echo ($PSIDBUpdateDT); ?>"
    });
    form.show();
  });
</script>
