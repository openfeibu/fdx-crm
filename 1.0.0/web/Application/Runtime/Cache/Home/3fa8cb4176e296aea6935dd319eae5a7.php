...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Sale/WSMainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<!-- GoodsPrice会mix到WSEditForm，所以需要放在其前面引用 -->
...
<script>
  PCL.onReady(() => {
    ...
    app.add(PCL.create("PSI.Sale.WSMainForm", {
      permission
    }));
  });
</script>
