...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Funds/PayMainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Funds/PaymentEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Factory/FactoryField.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
  PCL.onReady(() => {
    ...
    app.add(PCL.create("PSI.Funds.PayMainForm"));
  });
</script>
