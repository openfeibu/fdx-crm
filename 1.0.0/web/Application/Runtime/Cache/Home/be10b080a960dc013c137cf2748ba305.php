...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Report/SaleDetailForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
  PCL.onReady(() => {
    ...
    app.add(PCL.create("PSI.Report.SaleDetailForm"));
  });
</script>
