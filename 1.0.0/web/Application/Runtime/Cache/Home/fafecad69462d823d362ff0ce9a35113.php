...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/SaleOrder/SOMainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/SaleOrder/ChangeOrderEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>

<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Sale/WSEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Sale/WSExportForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Sale/WSImportForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<!-- 生成采购订单 -->
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/PurchaseOrder/POEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
  PCL.onReady(() => {
    ...
    const permission = {
      ...
      confirm: "<?php echo ($pConfirm); ?>",
      genWSBill: "<?php echo ($pGenWSBill); ?>",
      genPOBill: "<?php echo ($pGenPOBill); ?>",
      print: "<?php echo ($pPrint); ?>",
      showAddGoodsButton: "<?php echo ($showAddGoodsButton); ?>",
      closeBill: "<?php echo ($pCloseBill); ?>"
    };

    app.add(PCL.create("PSI.SaleOrder.SOMainForm", {
      permission
    }));
  });
</script>
