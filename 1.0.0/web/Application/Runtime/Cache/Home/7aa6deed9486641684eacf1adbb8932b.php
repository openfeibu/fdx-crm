...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Goods/PriceSystemMainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Goods/PriceSystemEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
  PCL.onReady(() =>{
    ...
    app.add(PCL.create("PSI.Goods.PriceSystemMainForm"));
  });
</script>
