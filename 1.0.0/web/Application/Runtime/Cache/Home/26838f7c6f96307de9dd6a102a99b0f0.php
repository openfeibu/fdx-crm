...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/AFX/BaseOneGridMainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>

<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Warehouse/MainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Warehouse/EditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Warehouse/EditDataOrgForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/User/SelectUserDataOrg.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/User/OrgField.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
  PCL.onReady(() => {
    ...
    app.add(PCL.create("PSI.Warehouse.MainForm", {
      pAdd: "<?php echo ($pAdd); ?>",
      pEdit: "<?php echo ($pEdit); ?>",
      pDelete: "<?php echo ($pDelete); ?>",
      pEditDataOrg: "<?php echo ($pEditDataOrg); ?>",
      pInitInv: "<?php echo ($pInitInv); ?>"
    }));
  });
</script>
