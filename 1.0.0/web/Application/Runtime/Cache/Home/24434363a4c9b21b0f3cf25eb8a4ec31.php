...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Report/SaleDayByGoodsForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
  PCL.onReady(() => {
    ...
    app.add(PCL.create("PSI.Report.SaleDayByGoodsForm"));
  });
</script>
