...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Report/PurchaseDetailForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<!-- 打印 -->
<script src="<?php echo ($uri); ?>Public/Lodop/LodopFuncs.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
  PCL.onReady(() => {
    ...
    app.add(PCL.create("PSI.Report.PurchaseDetailForm"));
  });
</script>
