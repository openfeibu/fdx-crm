...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Inventory/InvQueryMainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
  PCL.onReady(() => {
    const app = PCL.create("PSI.App", {
      ...
      appHeaderInfo: { title: "<?php echo ($title); ?>" }
    });

    app.add(PCL.create("PSI.Inventory.InvQueryMainForm", {
