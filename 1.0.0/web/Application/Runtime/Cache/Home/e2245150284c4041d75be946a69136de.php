...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/BizConfig/MainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/BizConfig/EditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script>
  PCL.onReady(() => {
    ...
    app.add(PCL.create("PSI.BizConfig.MainForm"));
  });
</script>
