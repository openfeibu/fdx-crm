...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Goods/MainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Goods/CategoryEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Goods/GoodsEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Goods/GoodsImportForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Goods/SafetyInventoryEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Goods/GoodsParentCategoryField.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Goods/GoodsBrandField.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Goods/GoodsBOMEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Goods/SubGoodsField.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Goods/GoodsUnitField.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>

<script src="<?php echo ($uri); ?>Public/Scripts/PSI/Goods/GoodsPriceSystemEditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script>
  PCL.onReady(() => {
    ...
    app.add(PCL.create("PSI.Goods.MainForm", {
      pAddCategory: "<?php echo ($pAddCategory); ?>",
      pEditCategory: "<?php echo ($pEditCategory); ?>",
      pDeleteCategory: "<?php echo ($pDeleteCategory); ?>",
      pAddGoods: "<?php echo ($pAddGoods); ?>",
      pEditGoods: "<?php echo ($pEditGoods); ?>",
      pDeleteGoods: "<?php echo ($pDeleteGoods); ?>",
      pImportGoods: "<?php echo ($pImportGoods); ?>",
      pGoodsSI: "<?php echo ($pGoodsSI); ?>",
      pAddBOM: "<?php echo ($pAddBOM); ?>",
      pEditBOM: "<?php echo ($pEditBOM); ?>",
      pDeleteBOM: "<?php echo ($pDeleteBOM); ?>",
      pPriceSystem: "<?php echo ($pPriceSystem); ?>",
      pExcel: "<?php echo ($pExcel); ?>"
    }));
  });
</script>
