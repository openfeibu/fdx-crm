...
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/PurchaseRej/PRMainForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/PurchaseRej/PREditForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
<script src="<?php echo ($uri); ?>Public/Scripts/PSI/PurchaseRej/PRSelectPWBillForm.js?dt=<?php echo ($dtFlag); ?>" type="text/javascript"></script>
...
<script>
  PCL.onReady(() => {
    ...
    app.add(PCL.create("PSI.PurchaseRej.PRMainForm", {
      permission
    }));
  });
</script>
