 ...
 * @license GPL v3
 */
PCL.define("PSI.Report.SaleDayByGoodsForm", {
    ...
    var r = {
      ...
      callback: function (options, success, response) {
        ...
        if (success) {
          ...
          me.previewReport("销售日报表(按商品汇总)", data);
        }
      }
    };
    me.ajax(r);
  ...
  onPrint: function () {
    ...
    var r = {
      ...
      callback: function (options, success, response) {
        ...
        if (success) {
          var data = response.responseText;
          me.printReport("销售日报表(按商品汇总)", data);
        }
      }
    };
    me.ajax(r);
  ...
  onPDF: function () {
    ...
    var url = "Home/Report/saleDayByGoodsPdf?limit=-1&dt=" + dt;
    if (sorter) {
      url += "&sort=" + sorter;
    }
  ...
  onExcel: function () {
    ...
    var url = "Home/Report/saleDayByGoodsExcel?limit=-1&dt=" + dt;
    if (sorter) {
      url += "&sort=" + sorter;
    }
